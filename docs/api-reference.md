...
| [`src/input_reader/types.ts`](#src-input-reader-types-ts)                                             | `.`, `./shell`, `./remote`, `./terminal` |          0 |      12 |         12 |
...
| [`src/pointer_input.ts`](#src-pointer-input-ts)                                                       | `.`, `./web`, `./shell`                  |          0 |      40 |         40 |
...
| [`src/types.ts`](#src-types-ts)                                                                       | `.`, `./app`, `./shell`, `./remote`      |          0 |       8 |          8 |
...
| ---------------------------------- | ----- | --------------------------------------------- |
| `src/types.ts`                     | named | `type Rectangle`                              |
| `src/pointer_input.ts`             | named | `type PointerInputEvent`                      |
| `src/input_reader/types.ts`        | named | `type KeyPressEvent`, `type MouseScrollEvent` |
...
_Entrypoints: `.`, `./shell`, `./remote`, `./terminal`_
...
_Entrypoints: `.`, `./app`, `./shell`, `./remote`_
