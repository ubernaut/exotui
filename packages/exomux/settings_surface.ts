...
export class ExomuxSettingsSurface {
  ...
  /**
   * Routes a wheel notch (positive = down) to the given picker, scrolling its
   * viewport through the items without changing the selection — selection only
   * moves on a click or Enter/Space.
   */
